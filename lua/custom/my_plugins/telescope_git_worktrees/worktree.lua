...
local Log = require('custom.my_plugins.telescope_git_worktrees.logger')
local Hooks = require('custom.my_plugins.telescope_git_worktrees.hooks')
local Config = require('custom.my_plugins.telescope_git_worktrees.config')
...
local function change_dirs(path)
    ...
    Config = require('custom.my_plugins.telescope_git_worktrees.config')
