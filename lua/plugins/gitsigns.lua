    ...
    { -- Adds git related signs to the gutter, as well as utilities for managing changes
        ...
        opts = {
            ...
            on_attach = function(bufnr)
                ...
                end, { buffer=bufnr, desc = "] Navigate [G]it next change" })
                ...
                end, { buffer=bufnr, desc = "[ Navigate [G]it prev change" })

                -- Actions
                -- normal mode
                vim.keymap.set({"n","v"}, "<leader>gs", gitsigns.stage_hunk, { buffer=bufnr, desc = "[G]it [s]tage hunk" })
                vim.keymap.set({"n","v"}, "<leader>gr", gitsigns.reset_hunk, { buffer=bufnr, desc = "[G]it [r]eset hunk" })
                vim.keymap.set("n", "<leader>gS", gitsigns.stage_buffer, { buffer=bufnr, desc = "[G]it [S]tage buffer" })
